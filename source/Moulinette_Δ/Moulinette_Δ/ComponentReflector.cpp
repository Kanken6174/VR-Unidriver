...
void ComponentReflector::provideDataToComponent(VRComponent* component, string data)
{
...
string ComponentReflector::requestDataFromComponent(VRComponent* component)
{
	switch (component->gettype())
	{
	case BUTTON:
