...
/**
 * @brief A MadgwickRotator tracks the orientation of an object through the measurements of a gyroscope, an accelerometer, and a magnetometer. To do so it calculates the difference between the most recent measure and the last estimated orientation. Also uses a reference frame to correct deviations.
 * 
 */
...
public://methods defined in MadgwickRotator.cpp
	...
	/**
	 * @brief Update the orientation of your VR equipment.
	 * 
